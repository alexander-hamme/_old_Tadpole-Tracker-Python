...
The program will be implemented in both Java and Python, to increase portability (i.e. single executable JAR files) and allow wider access for biology researchers to use in the future. The Java code is available [here](https://github.com/alexander-hamme/Tadpole-Tracker).
