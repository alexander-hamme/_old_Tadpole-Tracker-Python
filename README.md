...
Approaches:
  ...
  * Detection: Convolutional neural networks will be the building block for the tadpole detection system. Currently, I am working on implementing and embedding an implementation of [YOLO](https://pjreddie.com/darknet/yolo/) trained on my dataset.
